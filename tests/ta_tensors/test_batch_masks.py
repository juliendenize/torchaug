...
class TestBatchMasks:
    ...
    def batch_masks(self):
        ...
        idx_sample = [(0, 1), (1, 2)]
        return BatchMasks(data, idx_sample=idx_sample)
    ...
    def test_cat(self, batch_masks):
        ...
        batch_masks_2 = BatchMasks(torch.tensor([[[5, 5, 0], [0, 5, 5]]]), idx_sample=[(0, 1)])
    ...
    def test_update_chunk_(self, batch_masks):
        ...
        chunk = BatchMasks(torch.tensor([[[6, 6, 0], [0, 6, 6]]]), idx_sample=[(0, 1)])
...
def test_convert_masks_to_batch_masks():
    ...
    assert batch_masks.idx_sample == expected_idx_sample
