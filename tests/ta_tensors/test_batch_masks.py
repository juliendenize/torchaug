...
class TestBatchMasks:
    ...
    def batch_masks(self):
        ...
        return BatchMasks(data, samples_ranges=samples_ranges)
    ...
    def test_cat(self, batch_masks):
        ...
        batch_masks_2 = BatchMasks(torch.tensor([[[5, 5, 0], [0, 5, 5]]]), samples_ranges=[(0, 1)])
    ...
    def test_update_chunk_(self, batch_masks):
        ...
        chunk = BatchMasks(torch.tensor([[[6, 6, 0], [0, 6, 6]]]), samples_ranges=[(0, 1)])
...
def test_convert_masks_to_batch_masks():
    ...
    assert batch_masks.samples_ranges == expected_samples_ranges
