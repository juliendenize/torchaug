...
def _log_api_usage_once(obj: Any) -> None:
    ...
    In a large ecosystem, it's often useful to track the
    ...
    open-source users since it is no-op by default. For more information, please refer to.
    ...
    * Logging policy: https://github.com/pytorch/vision/issues/5052;
    ...
    if not module.startswith("torchaug"):
        module = f"torchaug.internal.{module}"
